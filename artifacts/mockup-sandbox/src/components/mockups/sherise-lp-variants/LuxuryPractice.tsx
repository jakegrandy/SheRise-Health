...
export default function LuxuryPractice() {
  useEffect(() => {
    // Inject the fonts if not present
    const link = document.createElement("link");
    link.href = "https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500&family=Playfair+Display:ital,wght@0,400;0,500;1,400&display=swap";
    link.rel = "stylesheet";
    ...
    <div className="min-h-screen bg-[#FCFBF9] text-[#132A24] font-['Outfit'] selection:bg-[#E8D5A5] selection:text-[#132A24]">
      ...
      <section className="relative h-[90vh] min-h-[700px] flex items-center justify-center overflow-hidden bg-[#F4F1EB]">
        <div className="absolute inset-0 z-0">
          <img 
            src="/__mockup/images/sherise-luxury-hero.png" 
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center mt-20">
          <h1 className="font-['Playfair_Display'] text-5xl md:text-7xl lg:text-8xl text-white font-light leading-[1.1] mb-12 tracking-tight drop-shadow-sm">
            Elevating the Standard <br className="hidden md:block" /> of Women’s Care
          </h1>
          
          <a 
            href="#book"
            className="group relative inline-flex items-center justify-center px-10 py-4 text-sm tracking-[0.2em] uppercase text-white border border-white/40 hover:bg-white hover:text-[#132A24] transition-all duration-500 overflow-hidden"
          >
      ...
      <section id="systems" className="bg-[#F4F1EB] py-32 md:py-48 px-8 md:px-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-24">
            <div className="border-t border-[#132A24]/10 pt-12">
              <h3 className="font-['Playfair_Display'] text-3xl md:text-4xl mb-6">01. Hormonal Harmony</h3>
              <p className="text-xl md:text-2xl text-[#132A24]/70 leading-relaxed font-light">
                Navigating perimenopause and menopause with precision. We optimize your hormones using bioidentical therapies, restoring energy, clarity, and libido.
              </p>
            </div>
            
            <div className="border-t border-[#132A24]/10 pt-12">
              <h3 className="font-['Playfair_Display'] text-3xl md:text-4xl mb-6">02. Metabolic Restoration</h3>
              <p className="text-xl md:text-2xl text-[#132A24]/70 leading-relaxed font-light">
                Addressing weight resistance at its source. By evaluating insulin sensitivity, thyroid function, and cellular energy, we rebuild your metabolic flexibility.
              </p>
            </div>

            <div className="border-t border-[#132A24]/10 pt-12">
              <h3 className="font-['Playfair_Display'] text-3xl md:text-4xl mb-6">03. Nervous System Calibration</h3>
              <p className="text-xl md:text-2xl text-[#132A24]/70 leading-relaxed font-light">
                Chronic stress rewires the body. We assess cortisol rhythms and provide strategies to shift your system from survival mode back to a state of rest and repair.
              </p>
            </div>

            <div className="border-t border-[#132A24]/10 pt-12">
              <h3 className="font-['Playfair_Display'] text-3xl md:text-4xl mb-6">04. Reproductive Health</h3>
              <p className="text-xl md:text-2xl text-[#132A24]/70 leading-relaxed font-light">
                Expert management of complex gynecological concerns. From irregular cycles to pelvic pain, we offer nuanced, specialized care tailored to your anatomy.
              </p>
            </div>

            <div className="border-t border-[#132A24]/10 pt-12">
              <h3 className="font-['Playfair_Display'] text-3xl md:text-4xl mb-6">05. Strategic Lifestyle</h3>
              <p className="text-xl md:text-2xl text-[#132A24]/70 leading-relaxed font-light">
                The foundation of lasting health. We curate personalized guidance on nutrition, movement, and recovery that fits seamlessly into a demanding life.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="provider" className="py-32 md:py-48 px-8 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 md:gap-32 items-center">
          <div className="relative aspect-[3/4] w-full max-w-md mx-auto md:mx-0">
            <img 
              src="/__mockup/images/sherise-luxury-provider.png" 
              alt="Scarlett Grandy" 
      ...
      <section id="book" className="py-32 md:py-48 px-8 md:px-16 text-center">
        <div className="max-w-2xl mx-auto space-y-12">
          ...
          <div className="pt-8">
            <button className="group relative inline-flex items-center justify-center px-12 py-5 text-sm tracking-[0.2em] uppercase text-[#F4F1EB] bg-[#132A24] hover:bg-[#1B3B33] transition-colors duration-500">
      ...
      <footer className="border-t border-[#132A24]/10 py-16 px-8 md:px-16 text-sm tracking-widest uppercase text-[#132A24]/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8">
            <a href="#" className="hover:text-[#132A24] transition-colors">Contact</a>
          ...
          <div>
            &copy; {new Date().getFullYear()} SheRises Health
          </div>
        </div>
      </footer>
    </div>
