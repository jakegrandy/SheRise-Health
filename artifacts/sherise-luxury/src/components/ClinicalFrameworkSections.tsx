...
const frameworkItems: FrameworkItem[] = [
  {
    ...
    conditions: ["Perimenopause", "Menopause", "Postpartum", "PCOS", "Adrenal dysregulation", "Thyroid disorders", "Hormone replenishment therapy", "Vaginal dryness", "Painful sex"],
  },
  {
    number: "02",
  ...
  },
  {
    ...
    conditions: ["Irregular cycles", "PMS/PMDD", "Fertility planning", "PCOS", "Heavy periods", "Contraception", "Low sexual desire", "Vaginitis management", "STI testing and treatment"],
  },
  {
    number: "04",
