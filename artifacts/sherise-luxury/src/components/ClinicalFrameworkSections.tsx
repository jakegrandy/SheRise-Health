...
const frameworkItems: FrameworkItem[] = [
  {
    ...
    conditions: ["Perimenopause", "Menopause", "PCOS", "Adrenal dysregulation", "Thyroid disorders", "BHRT candidacy"],
  },
  {
    number: "02",
  ...
  },
  {
    ...
    conditions: ["Irregular cycles", "PMS/PMDD", "Fertility planning", "PCOS", "Heavy periods", "Contraception", "Vaginitis management", "STI testing and treatment"],
  },
  {
    number: "04",
