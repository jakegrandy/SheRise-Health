  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent selection:text-background">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 grid grid-cols-3 items-center px-8 py-10 md:px-16 text-primary">
        ...
        <div className="hidden md:flex gap-12 text-[11px] tracking-[0.25em] uppercase font-light justify-self-center">
        ...
        <a
          href="#book"
          className="text-[11px] tracking-[0.25em] uppercase font-light flex items-center gap-2 group justify-self-end"
        >
      ...
      <section className="py-32 md:py-48 px-8 md:px-16 max-w-[100rem] mx-auto relative z-20 bg-background overflow-hidden">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="font-serif text-4xl md:text-5xl lg:text-6xl font-light leading-[1.25] text-foreground flex-1">
            At She Rises Health, we serve <span className="italic text-accent">women of all ages</span>, offering comprehensive GYN care with a specialized focus on advanced <span className="italic text-accent">hormone optimization</span> and <span className="italic text-accent">metabolic health</span>.
          </motion.h2>
        </motion.div>
