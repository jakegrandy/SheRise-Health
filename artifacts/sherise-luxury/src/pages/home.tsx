    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent selection:text-background">
      ...
      <section className="py-32 md:py-48 px-8 md:px-16 max-w-[100rem] mx-auto relative z-20 bg-background overflow-hidden">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="font-serif italic text-2xl md:text-3xl font-light leading-[1.5] text-foreground/70 flex-1">
            She Rises is <span className="text-accent">reimagining</span> women's healthcare.
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          <motion.p variants={fadeUp} className="font-serif italic text-2xl md:text-3xl font-light leading-[1.5] text-foreground/70 flex-1">
            We serve women at every stage of life, including adolescence, reproductive years, midlife and beyond.
          </motion.p>
        </motion.div>
